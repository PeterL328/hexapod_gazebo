...
void MessageRelay::send_to_joint_group_position_callback(const hexapod_msgs::LegsJoints::ConstPtr &legs_joints) {
    ...
    joint_array_rad.data[0] = 0 - legs_joints->left_front_leg.coxa;
    joint_array_rad.data[1] = 0 - legs_joints->left_front_leg.femur;
    joint_array_rad.data[2] = 0 - legs_joints->left_front_leg.tibia;

    joint_array_rad.data[3] = 0 - legs_joints->left_mid_leg.coxa;
    joint_array_rad.data[4] = 0 - legs_joints->left_mid_leg.femur;
    joint_array_rad.data[5] = 0 - legs_joints->left_mid_leg.tibia;

    joint_array_rad.data[6] = 0 - legs_joints->left_back_leg.coxa;
    joint_array_rad.data[7] = 0 - legs_joints->left_back_leg.femur;
    joint_array_rad.data[8] = 0 - legs_joints->left_back_leg.tibia;
